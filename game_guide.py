...
def run_game():
    ...
    if choice == "Yes, I will enter.":
        ...
        if user_input:
            ...
            guide_responses = guide_gpt_conversation(user_inputs, conversation=conversation_history)  # Pass the conversation history
            for guide_response in guide_responses:
                st.write("Guide:", guide_response)

        # Display the conversation with the tree
        st.subheader("Conversation with the Tree")
        tree_responses = guide_gpt_conversation([], conversation=conversation_history)  # Pass the conversation history to the tree
        ...
        guide_responses = guide_gpt_conversation(user_inputs, conversation=conversation_history)
        for guide_response in guide_responses:
            st.write("Guide:", guide_response)

    # Append the conversation history
    conversation_history.extend(guide_responses)
